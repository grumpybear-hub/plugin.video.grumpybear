...
class source:
    def __init__(self):
        ...
        self.header_preauth={'Content-Type': 'application/json','Accept-Charset': 'UTF-8,*', 'X-Emby-Authorization': 'MediaBrowser Client="Kodi grumpybear",Device="LAssthi",DeviceId="xxx",Version="1.0"', 'Accept-encoding': 'gzip', 'Authorization': 'MediaBrowser Client="Kodi Lasthip",Device="grumpybear",DeviceId="xxx",Version="1.0.0"'}
    ...
    def __authenticate(self):
        try:
            ...
            self.header_postauth={'Content-Type': 'application/x-www-form-urlencoded','Accept-Charset': 'UTF-8,*', 'X-Emby-Authorization': 'MediaBrowser UserId='+self.userid+',Client="Kodi grumpybear",Device="grumpybear",DeviceId="xxx",Version="1.0"', 'Accept-encoding': 'gzip', 'Authorization': 'MediaBrowser UserId='+self.userid+',Client="Kodi grumpybear",Device="grumpybear",DeviceId="xxx",Version="1.0"', 'X-MediaBrowser-Token':self.token}
