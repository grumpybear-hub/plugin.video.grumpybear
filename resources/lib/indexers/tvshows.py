...
class tvshows:
    ...
    def genres(self):
        ...
        if self.PersonalTVShowGenre == "true":
            genres.append((control.setting('PersonalTVShowGenreTitle1'),control.setting('PersonalTVShowGenre1'),False))
            genres.append((control.setting('PersonalTVShowGenreTitle2'),control.setting('PersonalTVShowGenre2'),False))
            genres.append((control.setting('PersonalTVShowGenreTitle3'),control.setting('PersonalTVShowGenre3'),False))
            genres.append((control.setting('PersonalTVShowGenreTitle4'),control.setting('PersonalTVShowGenre4'),False))
            genres.append((control.setting('PersonalTVShowGenreTitle5'),control.setting('PersonalTVShowGenre5'),False))
    ...
    def tvshowDirectory(self, items):
        ...
        watchedMenu = "In Trakt [I]Gesehen[/I]" if trakt.getTraktIndicatorsInfo() == True else "In Grumpybear [I]Gesehen[/I]"

        unwatchedMenu = "In Trakt [I]Ungesehen[/I]" if trakt.getTraktIndicatorsInfo() == True else "In Grumpybear [I]Ungesehen[/I]"
